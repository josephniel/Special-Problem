...
void main() {
    ...
    tdbOpenConnection( dataStore );
        ...
        if ( !tdbTableExists( dataStore, table ) ) {
            ...
            // CREATE NEW TABLE
            print( "[app_store_markers.sc] Creating new table." );
        ...
        print( "[app_store_markers.sc] Populating table..." );
        ...
        pd_shared3p float64 input_odds_ratio = argument( "input_odds_ratio" );
        tdbVmapAddValue( parameters, "values", input_odds_ratio );
    
        // INSERT MAPPED VALUES TO DATABASE TABLE
        print( "[app_store_markers.sc] Inserting row." );  
